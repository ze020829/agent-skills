# OSF Pre-Registration: Meihua Yishu Prediction Validation Study
...
Based on power analysis for McNemar's test (Connor, 1987). Sample size formula:
...
3. Select "OSF Standard Pre-Data Collection Registration"
4. Copy this content into the form
5. Submit before collecting any data

**Registration Date**: January 18, 2026
**Registration URL**: https://osf.io/uvntf
**Registration DOI**: [10.17605/OSF.IO/UVNTF](https://doi.org/10.17605/OSF.IO/UVNTF)
**Associated Project**: https://osf.io/xps43
